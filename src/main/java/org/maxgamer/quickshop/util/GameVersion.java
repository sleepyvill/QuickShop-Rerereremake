...
public enum GameVersion {
    ...
    v1_18_R1(false, true, true, true, true, true),
    v1_18_R2(false, true, true, true, true, true),
    v1_19_R1(false, true, true, true, true, true),
    v1_19_R2(false, true, true, true, true, true),
    v1_19_R3(false, true, true, true, true, true),
    v1_20_R1(false, true, true, true, true, true),
    v1_20_R2(false, true, true, true, true, true),
    v1_20_R3(false, true, true, true, true, true),
